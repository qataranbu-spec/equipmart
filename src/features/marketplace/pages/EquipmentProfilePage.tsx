...
import { MapPin, Calendar, Eye, Heart, Share2, Phone, Mail, MessageCircle, Shield, Star, User } from 'lucide-react';
import EquipmentPerspectiveView from '../components/EquipmentPerspectiveView';

type UserRole = 'buyer' | 'seller' | 'financier' | 'insurance' | 'contractor' | 'expert';

const EquipmentProfilePage = () => {
  const { id } = useParams();
  ...
  const getRoleLabel = (role: UserRole) => {
    const labels = {
      buyer: 'Equipment Buyer',
      seller: 'Equipment Seller',
      financier: 'Equipment Financier',
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
          ...
          {/* Middle Column - Role-specific Perspective */}
          <div className="xl:col-span-1">
            <EquipmentPerspectiveView equipment={equipment} userRole={userRole} />
          </div>
