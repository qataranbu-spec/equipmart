                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {recentOrders.map(order => <div key={order.id} className="flex items-center justify-between p-4 border border-border rounded-lg">
                          <div>
          ...
          {userRole === 'seller' && <>
              <TabsContent value="listings">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {myListings.map(listing => <div key={listing.id} className="flex items-center space-x-4 p-4 border border-border rounded-lg">
                          <img src={listing.image} alt={listing.title} className="w-20 h-20 object-cover rounded-lg" />
